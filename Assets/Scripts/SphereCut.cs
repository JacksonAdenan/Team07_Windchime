...
public class SphereCut : MonoBehaviour
{
    public static bool Cut(Transform victim, Vector3 _pos)
    {
        ...
        GameObject rightSideObj = GameObject.CreatePrimitive(PrimitiveType.Sphere); //primitivetype determines the shape after cutting
        ...
        GameObject leftSideObj = GameObject.CreatePrimitive(PrimitiveType.Sphere); //primitivetype determines the shape after cutting
